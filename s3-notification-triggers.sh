...
bucket_name="Suresh-ultimate-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="sureshkumar.conquerer@gmail.com"
...
aws sns publish \
  ...
  --message "Hello from Suresh Kumar YouTube channel, Learn Shell scripting for Free"
